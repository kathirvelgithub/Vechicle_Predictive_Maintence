...
def _stream_telematics_payload(
    ...
    return {
        ...
        "throttle_position_percent": record.get("throttle_position_percent"),
        "brake_pressure_psi": record.get("brake_pressure_psi"),
        "dtc_readable": record.get("dtc_readable"),
    ...
    try:
        ...
        if response["data"]:
            ...
            return {
                ...
                "coolant_temp_c": latest.get("coolant_temp_c", 0),
                "fuel_level_percent": latest.get("fuel_level_percent", 0),
                "throttle_position_percent": latest.get("throttle_position_percent", 0),
                "brake_pressure_psi": latest.get("brake_pressure_psi", 0),
