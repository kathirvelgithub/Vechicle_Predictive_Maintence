...
const API_OVERRIDE_KEY = "admin.runtime.apiBaseUrl";
...
export const getAuthBaseUrl = (): string => {
  const fromEnv = (import.meta.env.VITE_AUTH_BASE_URL as string | undefined)?.trim();
  return fromEnv || DEFAULT_AUTH_BASE_URL;
};
